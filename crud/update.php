...
<div class="container">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
        ...
        <div class="form-group">
            <label>Jurusan :</label>
            <input type="text" name="jurusan" class="form-control"value="<?php echo $data['jurusan'] ?>" placeholder="Masukan Jurusan" required/>
        </div>
        <div class="form-group">
            <label>No HP:</label>
        ...
        <div class="form-group">
            <label>Alamat:</label>
            <textarea type="text" name="alamat" class="form-control" rows="5" value="<?php echo $data['alamat'] ?>" placeholder="Masukan Alamat" required></textarea>
        </div>
